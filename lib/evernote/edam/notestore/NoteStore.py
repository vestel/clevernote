...
class getSyncChunk_args(object):
  ...
  def __init__(self, authenticationToken=None, afterUSN=None, maxEntries=None,):
    self.authenticationToken = authenticationToken
      ...
      if fid == 0:
        if ftype == TType.LIST:
          ...
          for _i134 in xrange(_size130):
            _elem135 = evernote.edam.type.ttypes.Notebook()
            _elem135.read(iprot)
      ...
      if fid == 0:
        if ftype == TType.LIST:
          ...
          for _i141 in xrange(_size137):
            _elem142 = evernote.edam.type.ttypes.Tag()
            _elem142.read(iprot)
      ...
      if fid == 0:
        if ftype == TType.LIST:
          ...
          for _i148 in xrange(_size144):
            _elem149 = evernote.edam.type.ttypes.Tag()
            _elem149.read(iprot)
      ...
      if fid == 0:
        if ftype == TType.LIST:
          ...
          for _i155 in xrange(_size151):
            _elem156 = evernote.edam.type.ttypes.SavedSearch()
            _elem156.read(iprot)
...
class findNoteCounts_args(object):
  ...
  def __init__(self, authenticationToken=None, filter=None,):
    self.authenticationToken = authenticationToken
    self.filter = filter
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i169 in xrange(_size165):
            ...
            self.noteGuids.append(_elem170)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class getResource_args(object):
  ...
  def write(self, oprot):
    ...
    if self.withAttributes != None:
      ...
      oprot.writeFieldEnd()
    if self.withAlternateData != None:
      ...
      if fid == 0:
        if ftype == TType.LIST:
          ...
          for _i176 in xrange(_size172):
            _elem177 = evernote.edam.type.ttypes.Ad()
            _elem177.read(iprot)
      ...
      if fid == 0:
        if ftype == TType.LIST:
          ...
          for _i183 in xrange(_size179):
            _elem184 = evernote.edam.type.ttypes.SharedNotebook()
            _elem184.read(iprot)
...
class expungeSharedNotebooks_args(object):
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i190 in xrange(_size186):
            ...
            self.sharedNotebookIds.append(_elem191)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.sharedNotebookIds != None:
      ...
      for iter192 in self.sharedNotebookIds:
      ...
      if fid == 0:
        if ftype == TType.LIST:
          ...
          for _i197 in xrange(_size193):
            _elem198 = evernote.edam.type.ttypes.LinkedNotebook()
            _elem198.read(iprot)
...
class expungeLinkedNotebook_args(object):
  ...
  def __init__(self, authenticationToken=None, linkedNotebookId=None,):
    self.authenticationToken = authenticationToken
