...
class SyncChunk(object):
  ...
  def __init__(self, currentTime=None, chunkHighUSN=None, updateCount=None, notes=None, notebooks=None, tags=None, searches=None, resources=None, expungedNotes=None, expungedNotebooks=None, expungedTags=None, expungedSearches=None,):
    self.currentTime = currentTime
...
class NoteCollectionCounts(object):
  ...
  def __init__(self, notebookCounts=None, tagCounts=None,):
...
class AdParameters(object):
  ...
  def __init__(self, clientLanguage=None, impressions=None, supportHtml=None,):
...
class NoteEmailParameters(object):
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i120 in xrange(_size116):
            ...
            self.toAddresses.append(_elem121)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.LIST:
          ...
          for _i126 in xrange(_size122):
            ...
            self.ccAddresses.append(_elem127)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 5:
  ...
  def write(self, oprot):
    ...
    if self.toAddresses != None:
      ...
      for iter128 in self.toAddresses:
    ...
    if self.ccAddresses != None:
      ...
      for iter129 in self.ccAddresses:
