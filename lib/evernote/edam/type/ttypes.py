...
class Notebook(object):
  ...
  def __init__(self, guid=None, name=None, updateSequenceNum=None, defaultNotebook=None, serviceCreated=None, serviceUpdated=None, publishing=None, published=None,):
    self.guid = guid
    self.name = name
    self.updateSequenceNum = updateSequenceNum
...
class SharedNotebook(object):
  ...
  def __init__(self, id=None, userId=None, notebookGuid=None, email=None, notebookModifiable=None, requireLogin=None, serviceCreated=None, shareKey=None, username=None,):
    self.id = id
    self.userId = userId
    self.notebookGuid = notebookGuid
    self.email = email
...
class LinkedNotebook(object):
  ...
  def __init__(self, id=None, shareName=None, username=None, shardId=None, shareKey=None, uri=None,):
    self.id = id
